    ...
    <Layout>
      ...
      <div className="max-w-3xl m-auto">
        <div className="flex flex-col align-center text-center iAWriterDuospace">
          ...
          <h2 className=" mt-6 text-3xl transition-colors dark:text-gray-200">Digital Notes</h2>
          <h6 className=" mt-6 text-md transition-colors dark:text-gray-400">notes on things</h6>
        </div>
