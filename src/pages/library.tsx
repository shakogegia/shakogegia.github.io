...
const books = [
  ...
  },
  {
    ...
    author: 'Philip K. Dick',
    cover:
      'https://i.gr-assets.com/images/S/compressed.photo.goodreads.com/books/1507838927l/36402034._SY475_.jpg',
  ...
  },
  {
    ...
    author: 'Philip K. Dick',
    cover:
      'https://i.gr-assets.com/images/S/compressed.photo.goodreads.com/books/1338461946l/14185.jpg',
  ...
  },
  {
    ...
    author: 'Daniel Keyes',
    cover:
      'https://i.gr-assets.com/images/S/compressed.photo.goodreads.com/books/1510416245l/36576608.jpg',
  ...
  },
  {
    ...
    cover:
      'https://i.gr-assets.com/images/S/compressed.photo.goodreads.com/books/1540169016l/42410904._SY475_.jpg',
  ...
  },
  {
    ...
    author: 'Stieg Larsson',
    cover:
      'https://i.gr-assets.com/images/S/compressed.photo.goodreads.com/books/1351778881l/5060378.jpg',
  ...
  },
  {
    ...
    author: 'Stieg Larsson',
    cover:
      'https://i.gr-assets.com/images/S/compressed.photo.goodreads.com/books/1327708260l/6892870.jpg',
  ...
  },
  {
    ...
    author: 'Patrick Rothfuss',
    cover:
      'https://i.gr-assets.com/images/S/compressed.photo.goodreads.com/books/1452624392l/1215032.jpg',
  ...
  },
  {
    ...
    cover:
      'https://i.gr-assets.com/images/S/compressed.photo.goodreads.com/books/1353467455l/13651.jpg',
  ...
  return (
    <Layout>
      <div className="flex flex-col align-center text-center mt-4">
        <span className="text-9xl text-indigo-500">
        ...
        <h6 className="mt-6 text-md font-mono max-w-md mx-auto text-gray-500">
          Here are some of the books I love, admire and find myself frequently
          returning to them.
          <p>
            As you can see I'm huge fan of the Sci-Fi and thanks Philip K. Dick
            for that
          </p>
        </h6>
      </div>
          ...
          <article key={book.title}>
            <div className="relative">
              <img
                src={book.cover}
                alt={book.title}
                className="mb-2 rounded-md w-[230px] h-[342px] object-cover"
              />
              <div className="absolute inset-0 bg-white bg-opacity-60 transition-all opacity-0 hover:opacity-100 flex justify-center items-center">
                <Link href={book.href}>
                  <a
                    target="_blank"
                    rel="noreferrer"
                    className="bg-white rounded px-4 py-2 flex items-center space-x-2"
                  >
            ...
            <h3 className="iAWriterQuattro text-xl text-gray-900">
              {book.title}
            </h3>
