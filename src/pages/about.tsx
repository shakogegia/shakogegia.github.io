...
export default function About() {
  return (
    <Layout>
      ...
      <article className="prose md:prose-lg max-w-none iAWriterDuospace font-light mt-8 text-gray-600 transition-colors dark:text-gray-300 dark:prose-a:text-gray-200">
